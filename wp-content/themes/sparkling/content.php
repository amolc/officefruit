	...
	<div class="blog-item-wrap row">
		...
		<div class="post-inner-content col-sm-9">
			...
			<div class="entry-summary">
				<?php the_excerpt(); ?>
				<a class="btn read-more" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More', 'sparkling' ); ?></a>
			</div><!-- .entry-summary -->
			<?php else : ?>
			<div class="entry-content">
				...
				<a class="btn read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Read More', 'sparkling' ); ?></a>
